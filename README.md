...
🛒 pantofle-karpaty — Next.js 14 · Stripe · InPost · Prisma · NeonDB
...
📈 stock-market-demo — Go · PostgreSQL · Docker
...
🚗 bot-skarbowy — Python · Google Gemini · GitHub Actions
...
🧠 agent-zdrowie — Next.js · OpenAI · Neon · Prisma
...
⚡ uk-energy (backend · frontend) — Node/Express · Next.js · TypeScript · Vitest · Docker
...
🧬 Kalkulator-Tm-Sekwencji-DNA — Python · Tkinter
...
Więcej projektów (strony korporacyjne, podróże, lokalne biznesy) znajdziesz na moim profilu →
